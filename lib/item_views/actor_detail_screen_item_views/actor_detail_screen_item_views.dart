...
class ActorInfoDetail extends StatelessWidget {
  const ActorInfoDetail({super.key});

  @override
  Widget build(BuildContext context) {
    return    const Padding(
      padding: EdgeInsets.all(kSP8x),
      child: SizedBox(
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Divider(color: Colors.grey,thickness: 2,),
              MovieSliderWidget(movieTitle: 'Darkest Hour', vote: 12345, rate: 8.4, imagePath: 'https://image.tmdb.org/t/p/w500/5Ao4qAFbjP7fcFOOdMNvQEnl0Yr.jpg', height: 250,)
            ],
          ),
        ),
      ),
